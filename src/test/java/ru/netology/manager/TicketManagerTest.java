...
public class TicketManagerTest {
    ...
    private Ticket ticket4 = new Ticket(444, 3400, "MOW", "POV", 260);
    private Ticket ticket5 = new Ticket(555, 3400, "POV", "KZN", 150);
    private Ticket ticket6 = new Ticket(666, 6000, "VKO", "POV", 230);
    private Ticket ticket7 = new Ticket(777, 5200, "MOW", "POV", 280);
    private Ticket ticket8 = new Ticket(888, 8000, "MOW", "POV", 240);
    ...
    public void shouldSortByTime() {
        ...
        Ticket[] expected = new Ticket[] {ticket1, ticket8, ticket4, ticket7};
        Ticket[] actual = manager.findAll("MOW", "POV", new TicketByTimeAscComparator());
